...
def delete_segment(tenantName, segmentName):
    method = 'DELETE'
    path = '/api/v1/data/controller/applications/bcf/tenant[name="%s"]/segment[name="%s"]' % (tenantName, segmentName)
    controller_request(method, path, data="")
